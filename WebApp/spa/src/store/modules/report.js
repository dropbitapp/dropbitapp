        ...
        if(state.production.Part1List[i].SpiritCatName === 'Total')
        {
          ...
          for (let iter = 0; iter < state.production.Part1List.length; iter++) {
            if (state.production.Part1List[iter].SpiritCatName !== 'Total') {
              totalsColumn.ProccessingAcct += state.production.Part1List[iter].ProccessingAcct;
              totalsColumn.ProducedTotal += state.production.Part1List[iter].ProducedTotal;
              totalsColumn.Recd4RedistilL17 += state.production.Part1List[iter].Recd4RedistilL17;
              totalsColumn.Recd4RedistilaltionL15 += state.production.Part1List[iter].Recd4RedistilaltionL15;
              totalsColumn.StorageAcct += state.production.Part1List[iter].StorageAcct;
              totalsColumn.UnfinishedSpiritsEndOfQuarterL17 += state.production.Part1List[iter].UnfinishedSpiritsEndOfQuarterL17;
            }
          }
          return totalsColumn;
        } 
    ...
    productionReportPart6(state) {
      ...
      for (let i = 0; i < part6List.length; i++) {
        if (part6List[i].ProdReportMaterialCategoryID === 1)
        {
          ...
          {
            if (part6.grain.line_7.material === '')
            {
        ...
        else if (part6List[i].ProdReportMaterialCategoryID === 2)
        {
          ...
          {
            if (part6.fruit.line_10.material === '')
            {
        ...
        if (part6List[i].ProdReportMaterialCategoryID === 3)
        {
          ...
          {
            if (part6.cane.line_16.material === '')
            {
